...
public class TC13_invalid_ssn_forgot_password extends reportGenerator
{
	screenshot shot = new screenshot(hooks.driver);
	forgetPassword fr = new forgetPassword(hooks.driver);
	
	@When("he enters valid firstname {string} and valid lastname {string} and valid address {string} and valid city {string} and valid state {string} and valid zipcode {string} and invalid ssn {string}")
	public void he_enters_valid_firstname_and_valid_lastname_and_valid_address_and_valid_city_and_valid_state_and_valid_zipcode_and_invalid_ssn(String firstname, String lastname, String address, String city, String state, String zipcode, String ssn) throws InterruptedException 
	{	
	...
	public void system_displays_error_message_for_invalid_ssn() throws IOException 
	{
