...
public class TC09_invalid_address_forgot_password extends reportGenerator
{
	screenshot shot = new screenshot(hooks.driver);
	forgetPassword fr = new forgetPassword(hooks.driver);
	
	@When("he enters valid firstname {string} and valid lastname {string} and invalid address {string} and valid city {string} and valid state {string} and valid zipcode {string} and valid ssn {string}")
	public void he_enters_valid_firstname_and_valid_lastname_and_invalid_address_and_valid_city_and_valid_state_and_valid_zipcode_and_valid_ssn(String firstname, String lastname, String address, String city, String state, String zipcode, String ssn) throws InterruptedException 
	{	
	...
	public void system_displays_error_message_for_invalid_address() throws IOException 
	{
